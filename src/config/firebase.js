...
import { getFirestore, setDoc, doc, getDocs, collection, serverTimestamp, addDoc } from 'firebase/firestore';
...
export { auth, db, setDoc, doc, getDocs, collection, serverTimestamp, addDoc };
